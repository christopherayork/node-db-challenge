...
- A relational database is a type of database, SQL is the query language that interacts with the DB
- [ ] Why do tables need a `primary key`?
- There needs to be a key for every row to identify it in lookups, much like the index in an array.
- [ ] What is the name given to a table column that references the primary key on another table.
- A foreign key
- [ ] What do we need in order to have a _many to many_ relationship between two tables.
- An auxiliary controller that holds two foreign keys, used to act as an operator
